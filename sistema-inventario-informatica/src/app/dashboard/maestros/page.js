...
export default function MaestrosPage() {
    ...
    const tabs = [
        ...
        { id: "programas", label: "Programas", icon: FaBriefcase, endpoint: "/programa", idField: "id_programa", isMale: true, singularTitle: "Programa", fields: [{ name: "nombre_programa", label: "Nombre Programa", type: "text", required: true }] },
